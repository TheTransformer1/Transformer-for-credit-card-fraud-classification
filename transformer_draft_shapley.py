...
X_train, X_test, y_train, y_test = train_test_split(X_scaled, y, test_size=0.2, random_state=412, stratify=y)
...
background = shap.sample(X_train_tensor.numpy(), 500)
test_data = X_test_tensor[100:150].numpy()
